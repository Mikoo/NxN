...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "camera_fleet_title": "Multi-Camera Network & Surveillance Fleet",
        "add_camera_btn": "➕ Connect New IP / USB Camera",
        "active_preview_cam": "Active Stream Camera",
        "sentry_mode_label": "Sentry Surveillance Mode",
        "sentry_patrol_mode": "🌐 Smart Patrol (Rotate Enabled Fleet)",
        "sentry_focus_mode": "🎯 Focus on Active Camera Only",
        "camera_name_label": "Camera Name / Alias",
        "camera_zone_label": "Room / Physical Zone",
        "camera_protocol_label": "Protocol",
        "camera_ip_label": "IP Address / Hostname",
        "camera_port_label": "Port (RTSP / HTTP)",
        "camera_user_label": "Username",
        "camera_pass_label": "Password",
        "camera_path_label": "Stream Path (e.g. /profile0)",
        "camera_usb_idx_label": "USB Camera Index",
        "test_camera_btn": "🔌 Test Live Stream",
        "save_camera_btn": "💾 Save Camera to Network",
        "preset_brand_label": "Quick Manufacturer Preset",
    ...
    "es": {
        ...
        "camera_fleet_title": "Red de Cámaras y Flota de Vigilancia Doméstica",
        "add_camera_btn": "➕ Conectar Nueva Cámara IP / USB",
        "active_preview_cam": "Cámara para Vista Previa",
        "sentry_mode_label": "Modo de Vigilancia Centinela",
        "sentry_patrol_mode": "🌐 Patrullaje Inteligente (Flota Habilitada)",
        "sentry_focus_mode": "🎯 Foco en Cámara Activa Únicamente",
        "camera_name_label": "Nombre / Alias de la Cámara",
        "camera_zone_label": "Habitación / Zona Física",
        "camera_protocol_label": "Protocolo",
        "camera_ip_label": "Dirección IP Local / Host",
        "camera_port_label": "Puerto (RTSP / HTTP)",
        "camera_user_label": "Usuario",
        "camera_pass_label": "Contraseña",
        "camera_path_label": "Ruta del Stream (ej. /profile0)",
        "camera_usb_idx_label": "Índice de Cámara USB",
        "test_camera_btn": "🔌 Probar Conexión en Vivo",
        "save_camera_btn": "💾 Guardar Cámara en la Red",
        "preset_brand_label": "Preset Rápido de Fabricante",
